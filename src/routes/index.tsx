          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-gray-500 px-4 leading-relaxed">
                Contá tu historia, dejá tu mensaje.
              </p>
            </div>


            <div className="flex flex-col items-center">
              <div className="mb-4 w-16 h-16 bg-white rounded-full flex en items-center justify-center border border-gray-200 text-gray-700 shadow-sm">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <div className="font-bold text-sm mb-1 flex items-center gap-2">
                <span className="bg-black text-white w-5 h-5 rounded-full flex en items-center justify-center text-[10px]">
                  2
                </span>
              ...
              <p className="text-xs text-gray-500 px-4 leading-relaxed">
                Mantenemos el respeto antes de publicar.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-gray-500 px-4 leading-relaxed">
                Ya es parte del archivo mundial.
              </p>
            </div>
